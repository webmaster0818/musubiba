...
export const metadata: Metadata = {
  ...
  description:
    "結婚相談所の連盟（IBJ・BIU・TMS・良縁ネット・JBAなど）は、紹介してもらえる会員の母数を決める仕組みです。当サイトが実査した24社のうち16社が加盟連盟を公表しており、うち12社がIBJ系でした。ただし同じIBJのネットワークを使っていても月会費は7,550円〜17,050円、成婚料は80,000円〜300,000円と開きがあります。連盟の違いと、連盟で選んではいけない理由を実額つきで解説します。",
