...
const faqs = [
  ...
  {
    q: "成婚料0円の結婚相談所はどこですか？",
    a: "当サイトの検証済みデータでは、オンライン型のスマリッジ・エン婚活結婚相談所・naco-do・ウェルスマは成婚料0円です（2026年7月当サイト公式確認）。一方、仲人型のIBJメンバーズは成婚料220,000円、サンマリエ・ムスベルなども成婚料がかかります。成婚料0円型は「早く成婚するほど得」、成婚料あり型は「成婚まで伴走する動機がサポート側にある」とも言われ、一長一短です。",
  },
  {
    q: "結婚相談所の月会費が一番安いのはどこですか？",
    a: "当サイトの検証済み10社では、スマリッジが月9,900円（税込）で最安クラスです（2026年7月当サイト公式確認・1年総額125,400円）。ただし月会費が安くてもお見合い料が都度かかる相談所では総額が膨らむことがあるため、月会費単体でなく1年総額での比較をおすすめします。",
  },
  {
    q: "お見合い料とは何ですか？かからない相談所はありますか？",
    a: "お見合いが成立するたびに支払う費用で、1回5,000〜10,000円程度の相談所があります。月会費が安く見えてもお見合い料で総額が増えるケースがあるため要注意です。当サイト検証ではスマリッジ（一定回数まで）・エン婚活・naco-do・ウェルスマなどはお見合い料0円型です（2026年7月確認・条件は各社最新情報をご確認ください）。",
  },
  {
