    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-10 text-[#2C2C2C]">
        ...
        <section className="mb-8">
          <h2 className="text-lg font-medium mb-3 border-l-4 border-[#A08447] pl-3">1. 評価・掲載の基準</h2>
        ...
        <section className="mb-8">
          <h2 className="text-lg font-medium mb-3 border-l-4 border-[#A08447] pl-3">2. 情報源と正確性</h2>
          <ul className="list-disc pl-5 text-sm space-y-1">
        ...
        <section className="mb-8">
          <h2 className="text-lg font-medium mb-3 border-l-4 border-[#A08447] pl-3">3. 口コミの扱い</h2>
        ...
        <section className="mb-8">
          <h2 className="text-lg font-medium mb-3 border-l-4 border-[#A08447] pl-3">4. 更新方針</h2>
          <p className="text-sm leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-lg font-medium mb-3 border-l-4 border-[#A08447] pl-3">5. 提携（アフィリエイト）の開示</h2>
          <p className="text-sm leading-relaxed">
        ...
        <p className="text-sm mt-10">
          関連：<Link href="/about/" className="text-[#A08447] underline">運営方針について</Link> ／ <Link href="/compare/" className="text-[#A08447] underline">結婚相談所の料金比較</Link>
        </p>
      </main>
    </>
  );
