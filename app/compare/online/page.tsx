...
export const metadata: Metadata = {
  ...
  description:
    "来店不要で活動できるオンライン結婚相談所を、月会費・初期費用・成婚料・特徴で比較。naco-do・スマリッジ・エン婚活など成婚料0円の低コスト型を中心に、忙しい人や地方在住でも始めやすいオンライン型の選び方を解説します。",
  alternates: { canonical: "/compare/online/" },
};

// 料金は2026年7月5日に各公式サイトで再検証済み。最新・正確な料金は各公式でご確認ください。
type Agency = { slug: string; name: string; monthly: string; matchingFee: string; type: string; point: string };
const agencies: Agency[] = [
  { slug: "naco-do", name: "naco-do（ナコード）", monthly: "16,800円（1プラン）", matchingFee: "0円", type: "完全オンライン", point: "1プランのシンプル料金体系に刷新。初期費用66,000円・成婚料0円・90日間出会えなければ全額返金（2026年7月5日確認）。" },
  { slug: "smartread", name: "スマリッジ", monthly: "9,900円", matchingFee: "0円", type: "完全オンライン", point: "初期費用6,600円・成婚料0円で1年総額125,400円と当サイト検証で最安（2026年7月5日確認）。" },
  { slug: "en-konkatsu", name: "エン婚活エージェント", monthly: "16,500円", matchingFee: "0円", type: "完全オンライン", point: "大手エン・ジャパン系。登録料33,000円・成婚料0円・3ヶ月お見合い不成立なら返金保証（2026年7月5日確認）。" },
...
const faqs = [
  ...
  { q: "オンライン結婚相談所で一番安いのは？", a: "1年活動の総額（2026年7月5日公式確認・税込）では、スマリッジが125,400円（登録6,600円＋月9,900円×12・成婚料0円）で最安です。エン婚活は231,000円、naco-doは267,600円。総額での詳しい比較は安い結婚相談所の総額比較（/compare/cheap/）をご覧ください。" },
