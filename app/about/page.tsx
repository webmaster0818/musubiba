    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-10 text-[#2C2C2C]">
        ...
        <section className="mb-8">
          <h2 className="text-lg font-medium mb-3 border-l-4 border-[#A08447] pl-3">「ムスビバ」について</h2>
        ...
        <section className="mb-8">
          <h2 className="text-lg font-medium mb-3 border-l-4 border-[#A08447] pl-3">ミッション</h2>
          <p className="text-sm leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-lg font-medium mb-3 border-l-4 border-[#A08447] pl-3">編集体制</h2>
          <p className="text-sm leading-relaxed">
            婚活・結婚相談所の料金やサービスを継続的に調査する編集部が、各社公式情報を確認したうえで記事を作成・更新しています。料金・成婚率・会員数などの数値は確認時点を明記し、確定できない項目は推測で補わず正直に記載します。詳細は<Link href="/editorial-policy/" className="text-[#A08447] underline">編集方針・掲載基準</Link>をご覧ください。
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-lg font-medium mb-3 border-l-4 border-[#A08447] pl-3">収益モデル（アフィリエイトの開示）</h2>
          <p className="text-sm leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-lg font-medium mb-3 border-l-4 border-[#A08447] pl-3">免責事項</h2>
          <p className="text-sm leading-relaxed">
        ...
        <p className="text-sm mt-10">
          関連：<Link href="/editorial-policy/" className="text-[#A08447] underline">編集方針・掲載基準</Link> ／ <Link href="/compare/" className="text-[#A08447] underline">結婚相談所の料金比較</Link> ／ <Link href="/compare/cheap/" className="text-[#A08447] underline">安い結婚相談所を総額で比較</Link>
        </p>
      </main>
    </>
  );
