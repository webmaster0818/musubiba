...
export const metadata: Metadata = {
  title: "仙台・宮城の結婚相談所一覧【46件調査・Google口コミ実データ】エリア別に比較",
  description:
    "仙台・宮城の実在する結婚相談所46件をGoogleマップの実データ(評点・口コミ件数・2026年9月6日取得)で調査し、仙台駅前・青葉区など主要エリア別に掲載。フォトスタジオ・式場等の別業態は実査で除外済み。口コミ3件以上の相談所は評点・所在地の詳細ページつき。評点は実数のみで創作はありません。",
...
export default function AreaPage() {
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
      <Breadcrumb items={[{ name: "仙台・宮城の結婚相談所" }]} />
      <h1 className="text-2xl sm:text-3xl font-bold text-[#2C2C2C] mt-4 mb-4">仙台・宮城の結婚相談所一覧【46件調査・Google口コミ実データ】</h1>
      <AgencyIndex pref="miyagi" prefName="宮城" />
