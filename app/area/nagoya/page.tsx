...
export const metadata: Metadata = {
  title: "名古屋・愛知の結婚相談所一覧【113件調査・Google口コミ実データ】エリア別に比較",
  description:
    "名古屋・愛知の実在する結婚相談所113件をGoogleマップの実データ(評点・口コミ件数・2026年8月23日取得)で調査し、名古屋駅・栄・金山・豊田・岡崎・一宮など主要エリア別に掲載。式場・ジュエリー店等の別業態は業種データで除外済み。口コミ3件以上の相談所は評点・所在地の詳細ページつき。評点は実数のみで創作はありません。",
...
export default function AreaPage() {
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
      <Breadcrumb items={[{ name: "名古屋・愛知の結婚相談所" }]} />
      <h1 className="text-2xl sm:text-3xl font-bold text-[#2C2C2C] mt-4 mb-4">名古屋・愛知の結婚相談所一覧【113件調査・Google口コミ実データ】</h1>
      <AgencyIndex pref="aichi" prefName="愛知" />
