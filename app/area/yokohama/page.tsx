...
export const metadata: Metadata = {
  title: "横浜・神奈川の結婚相談所一覧【約140件調査・Google口コミ実データ】エリア別に比較",
  description:
    "横浜・神奈川の実在する結婚相談所約140件をGoogleマップの実データ(評点・口コミ件数・2026年8月20日取得)で調査し、横浜駅・関内・新横浜・川崎・武蔵小杉・藤沢・相模原など主要エリア別に掲載。式場・ジュエリー店等の別業態は業種データで除外済み。口コミ3件以上の相談所は評点・所在地の詳細ページつき。評点は実数のみで創作はありません。",
...
export default function AreaPage() {
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
      <Breadcrumb items={[{ name: "横浜・神奈川の結婚相談所" }]} />
      <h1 className="text-2xl sm:text-3xl font-bold text-[#2C2C2C] mt-4 mb-4">横浜・神奈川の結婚相談所一覧【約140件調査・Google口コミ実データ】</h1>
      <AgencyIndex pref="kanagawa" prefName="神奈川" />
