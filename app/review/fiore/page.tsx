...
export const metadata = {
  ...
  description:
    "FIORE（フィオーレ）の口コミ・評判を徹底調査。関西中心・成婚率業界トップクラス・IBJ連携が特徴のフィオーレの料金やサポート体制を詳しく解説します。",
};

const overview = {
  name: "FIORE（フィオーレ）",
  type: "ハイブリッド型（仲人＋データマッチング）",
  members: "約8.5万人（IBJ連携含む）",
...
const strengths = [
  {
    ...
    desc: "フィオーレの成婚率は52.8%（自社発表）と業界でもトップクラスの数値を誇ります。カウンセラーによる丁寧なサポートと、IBJネットワークの活用が高い成婚率の要因となっています。",
  },
  {
    title: "IBJ連携で約8.5万人の出会いが可能",
    desc: "日本最大級の結婚相談所ネットワークであるIBJと連携しており、自社会員だけでなくIBJ加盟他社の会員ともお見合いが可能です。関西圏以外のお相手との出会いも広がります。",
  },
  {
...
const reviews = [
  {
    ...
    stars: 5,
    date: "2024年8月",
    text: "関西で婚活するならフィオーレが一番だと思います。成婚率が高いと聞いて入会しましたが、実際にカウンセラーのサポートが手厚く、IBJ連携で紹介される方も多かったです。入会から8ヶ月で素敵な方と出会い、成婚退会できました。",
  },
  {
    label: "30代男性・京都在住",
    stars: 4,
    date: "2024年6月",
    text: "初期費用が安いので始めやすかったです。IBJ連携のおかげで、関西圏だけでなく東京の方ともお見合いできました。カウンセラーの方が婚活のコツを丁寧に教えてくれて、プロフィール写真の選び方まで細かくアドバイスをもらえました。",
  },
  {
    label: "40代男性・神戸在住",
    stars: 4,
...
const faqs = [
  ...
  },
  {
    ...
    a: "IBJ連携を通じて全国の会員とお見合いが可能です。ただし、店舗は関西圏が中心のため、対面カウンセリングは関西での利用がメインとなります。オンライン対応も一部行っています。",
  },
  {
