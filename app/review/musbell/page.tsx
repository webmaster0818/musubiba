...
const strengths = [
  {
    ...
    desc: "IBJ、BIU、良縁ネットなど複数の結婚相談所連盟に加盟しており、約16万人という業界最大級の会員基盤にアクセスできます。圧倒的な出会いの選択肢が最大の強みです。",
  },
  {
...
const faqs = [
  ...
  },
  {
    ...
    a: "IBJ（日本結婚相談所連盟）、BIU（日本ブライダル連盟）、良縁ネットなど複数の連盟に加盟しています。これにより約16万人の会員基盤にアクセスできます。",
  },
  {
