...
const strengths = [
  ...
  },
  {
    ...
    desc: "安さだけでなく、IBJ加盟店としての会員ネットワークと、カウンセラーによる個別サポートを両立しています。低価格でも妥協のないサービスを提供している点が評価されています。",
  },
];
...
const reviews = [
  {
    ...
    stars: 5,
    date: "2024年8月",
    text: "月会費の安さが魅力で入会しました。成果報酬型なので、結果が出なければ大きな出費にならないという安心感があります。IBJ加盟なのでお相手の選択肢も十分で、カウンセラーの方も丁寧にサポートしてくれました。コスパ最高の結婚相談所だと思います。",
  },
  {
    label: "30代男性・神奈川在住",
    stars: 4,
  ...
  },
  {
    ...
    stars: 4,
    date: "2024年4月",
    text: "40代で婚活費用が気になっていましたが、セブンの成果報酬型は理にかなっていると感じました。結果が出た時だけ費用が発生するので、モチベーションにもつながります。IBJの会員基盤もあり、紹介される方の質は高かったです。",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: "IBJのシステムを通じてオンラインでの活動が可能です。お見合いもオンライン対応しています。カウンセリングも対面・オンラインの両方で対応しています。",
  },
  {
