  ...
  return (
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <div className="bg-[#FAF7F2] border border-[#E5DCCF] rounded-2xl p-6 sm:p-7 mb-10">
          <h2 className="text-base font-medium text-[#A08447] mb-4 tracking-widest flex items-center gap-2">
            <span className="inline-block w-1.5 h-5 bg-[#A08447] rounded-full" />結論：ヒーローマリッジはこんな人に向く
          </h2>
          <ul className="space-y-2.5 text-sm text-[#2C2C2C]/80 leading-relaxed">
            <li className="flex gap-2"><span className="text-[#A08447] shrink-0">●</span><span><strong>特徴</strong>：IBJ加盟の<strong>男性専門</strong>結婚相談所。プロカメラマン撮影何度でも無料＋写真ABテスト、データ重視の「ロジカル婚活」、月3名紹介＋LINEサポートが柱です。</span></li>
            <li className="flex gap-2"><span className="text-[#A08447] shrink-0">●</span><span><strong>料金</strong>：初期165,000円＋月14,300〜27,500円＋成婚料220,000円（税込・お見合い料0円）。<strong>スタンダードプランで1年成婚した場合の総額目安は約58.3万円</strong>です。</span></li>
            <li className="flex gap-2"><span className="text-[#A08447] shrink-0">●</span><span><strong>向く人</strong>：写真・プロフィールを徹底改善したい男性、感覚論ではなくデータで婚活を進めたい男性、オンライン中心で活動したい男性。</span></li>
            <li className="flex gap-2"><span className="text-[#A08447] shrink-0">●</span><span><strong>注意点</strong>：<strong>成婚率の公式数値は非公開</strong>で、第三者の口コミも少ないため、判断材料は無料相談での確認が中心になります（本文で見極めポイントを解説）。</span></li>
          </ul>
        ...
        <section className="mb-12">
          <h2 className="text-xl font-light mb-6 border-l-4 border-[#A08447] pl-4 tracking-widest">ヒーローマリッジの強み・特徴</h2>
        ...
        <section className="mb-12">
          ...
          <p className="text-xs text-[#2C2C2C]/50 leading-relaxed">
            ※金額はすべて税込・2026年7月に公式サイト（料金ページ）で確認した公表値です。契約は6ヶ月ごとの自動更新、契約書面受領日から8日以内はクーリングオフ可能とされています。プランごとのサポート内容の違い・中途解約時の精算条件は、無料相談と契約書面で必ずご確認ください。相場との比較は<Link href="/knowledge/cost/" className="underline text-[#A08447]">料金相場の解説</Link>も参考になります。
          </p>
        </section>

        <section className="mb-12">
          <h2 className="text-xl font-light mb-6 border-l-4 border-[#A08447] pl-4 tracking-widest">成婚実績はどう読むべきか（正直な解説）</h2>
          <p className="text-sm text-[#2C2C2C]/80 leading-relaxed mb-4">
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3 text-sm text-[#2C2C2C]/70">
            <li className="flex gap-2"><span className="text-[#A08447] shrink-0">1.</span><span><strong>客観的事実を確認する</strong>：IBJ加盟、特商法ページの運営者情報（株式会社アルファブル）、料金内訳の公開など、検証可能な情報は揃っています。トップページに法人名がない点は、特商法ページで自分の目で確認しておきましょう。</span></li>
            <li className="flex gap-2"><span className="text-[#A08447] shrink-0">2.</span><span><strong>無料相談で「数字」を質問する</strong>：成婚率が非公開のため、直近の成婚退会数・お見合い成立率・自分と近い年齢層の活動事例を具体的に聞き、回答の具体性を判断材料にします。</span></li>
            <li className="flex gap-2"><span className="text-[#A08447] shrink-0">3.</span><span><strong>契約条件を書面で確認する</strong>：6ヶ月自動更新の更新タイミング、中途解約時の精算、成婚の定義（IBJ準拠か）、成婚料の割引条件（自社イベント経由50%割引）の適用要件を必ず書面で確認しましょう。</span></li>
            <li className="flex gap-2"><span className="text-[#A08447] shrink-0">4.</span><span><strong>写真サポートの実際を確かめる</strong>：「何度でも無料」の撮影の予約の取りやすさや、ABテストの運用実態は無料相談で具体的に質問できると安心です。</span></li>
          </ul>
        </section>
      ...
      <A8Banner ad="hero" />
        ...
        <section className="mb-12">
          <h2 className="text-xl font-light mb-4 border-l-4 border-[#A08447] pl-4 tracking-widest">男性の婚活で比較したい相談所</h2>
          <p className="text-sm text-[#2C2C2C]/80 leading-relaxed mb-4">
            男性専門のヒーローマリッジと比較するなら、<Link href="/review/bridal-tulip/" className="text-[#A08447] underline">ブライダルチューリップ</Link>（高田馬場・3連盟で紹介可能会員約19万名）も候補になります。月会費7,550円〜と月額を抑えて始められる仲人型で、男性の入会も受け付けています。料金体系や成婚料の違いは各レビューで比較してください。男性会員としての費用実額・男性向けサポートの軸で複数社を見比べたい方は、<Link href="/mens/" className="text-[#A08447] underline">男性の結婚相談所おすすめ比較（男性向けハブ）</Link>もあわせてご覧ください。
          </p>
