...
const strengths = [
  ...
  {
    title: "IBJ連携で約8.7万人の会員基盤にアクセス",
    desc: "自社会員に加え、IBJ（日本結婚相談所連盟）と連携しており、約8.7万人の会員基盤にアクセスできます。仲人型の手厚いサポートと大規模な会員ネットワークの両方を活用できます。",
  },
];
...
const reviews = [
  ...
  },
  {
    ...
    stars: 4,
    date: "2024年5月",
    text: "老舗の安心感があり、入会を決めました。仲人さんが非常に経験豊富で、自分の強みや改善点を的確に教えてくれました。料金は安くはありませんが、サポートの質を考えれば妥当だと思います。IBJ連携でお相手の選択肢も十分にありました。",
  },
  {
    label: "30代男性・名古屋在住",
    stars: 4,
